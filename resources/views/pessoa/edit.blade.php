...
<div class="container-fluid mt--9">
    ...
    <div class="row">
        <div class="col-xl-12">
            <form method="post" action="{{route('pessoa.update' , ['id' => $pessoa->id])}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="nome">Título</label>
                            <input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o nome" value="{{$pessoa->nome}}" required>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
