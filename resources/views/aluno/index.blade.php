...
@include('layouts.headers.cards')
    ...
    <div class="mb-3 bg-white" style="border:2px solid #fff;padding:10px;border-radius:10px;border: 1px solid #ededed;display:flex;align-items: center ">
      ...
      <form id="form-search" action="{{ route('aluno.index') }}" class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                        ...
                        <tr>
                            <td style="padding: 10px;width: 50px">
                              <a href="{{ route('aluno.edit' , ['id' => $aluno->id]) }}" >
                                ...
                                <a href="{{ route('aluno.destroy' , ['id' => $aluno->id]) }}" >
                            ...
                            <th scope="row" style="width: 100px">{{$aluno->id}}</th>
                            <td>{{$aluno->nome}}</td>
                        </tr>
                        @endforeach
                    </tbody>
