...
<div class="container-fluid mt--9">
    ...
    <div class="row">
        <div class="col-xl-12">
            <form method="post" action="{{route('horario.update' , ['id' => $horario->id])}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="data" id="data" value="{{$horario->data}}" required>
                        </div>
                    </div>
